          ...
          <AreaChart data={series} margin={{ top: 8, right: 4, left: -12, bottom: 2 }}>
            <defs>
              <linearGradient id="aioScoreFill" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="95%" stopColor="#aa3bff" stopOpacity={0.02} />
              </linearGradient>
            </defs>
            ...
            <YAxis
              ...
              width={32}
            />
            <Tooltip content={<ChartTooltip />} cursor={{ stroke: '#aa3bff', strokeOpacity: 0.35 }} />
            <Area
              type="monotone"
              dataKey="score"
              name="AIO Score"
            ...
            <Line
              ...
              strokeWidth={2}
              dot={{ r: 3, fill: '#aa3bff' }}
              activeDot={{ r: 6, fill: '#c084fc', stroke: '#aa3bff', strokeWidth: 1.5 }}
